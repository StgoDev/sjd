...
<p class="page">&nbsp;&nbsp;página&nbsp;-&nbsp;</p>
			...
			<div id="img_left">
			<img src="img/cep_pmpi.jpg" width=50 height=75 />
			</div>
			<div id="img_right">
			<img src="img/pmpi.jpg" width=50 height=75 />
			</div>
			<div id="img_right_visto">
			<img src="img/visto.png" width=160 height=75 />
			</div>
...
<td><?php echo $studentsSubject['Student']['rg']; ?>&nbsp;</td>
<td><?php echo $studentsSubject['Student']['matricula']; ?>&nbsp;</td> 	
...
<div style="margin-top:15px;">		
		...
		<p  style="text-align: justify;line-height: 25px;">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		Terminaram com as médias finais empatada os alunos classificados na 5ª (quinta) e 6ª  (sexta) colocação ambos com 9,850 (nove virgula oitocentos e cinquenta) pontos, os alunos classificados na 19ª (décima nona) e 20ª ( vigésima) colocação ambos com 9,344( nove vírgula trezentos e quarenta e quatro) pontos, os alunos classificados na 24ª ( vigésima quarta) e 25ª (vigésima quinta) colocação ambos com 9,219 ( nove vírgula duzentos e dezenove) pontos, os alunos classificados na 27ª  (vigésima sétima) e 28ª (vigésima oitava) colocação ambos com 9.169 (nove vírgula cento e sessenta e nove) pontos, sendo utilizado para critério de desempate a precedência hierárquica anterior ao inicio do curso de formação de sargentos conforme a lei 3.808/81 (Estatuto dos Policias Militares do Estado do Piauí ) em sua alínea b, § 2° do artigo 15, sendo que os alunos ocupantes da 55ª (quinquagésima quinta) à 58º (quinquagésima oitava) colocação  foram reclassificados conforme resultado final das disciplinas em que ficaram  de recuperação, ou seja, em 01(uma), disciplina, conforme prescreve o art. 89 do Regimento Interno do CFAP.
		</p>
		<p  style="text-align: justify;line-height: 25px;">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
