<div class="rooms index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('nomesala'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($room['Course']['id'], array('controller' => 'courses', 'action' => 'view', $room['Course']['id'])); ?>
		</td>
		<td><?php echo h($room['Room']['nomesala']); ?>&nbsp;</td>
