<div class="studentsCourses index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $studentsCourse['StudentsCourse']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $studentsCourse['StudentsCourse']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
